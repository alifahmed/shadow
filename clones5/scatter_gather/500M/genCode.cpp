...
block9:
        ...
        out_9++;
        if (out_9 <= 2999999LL) goto block5;
        else if (out_9 <= 3000000LL) goto block14;
        else if (out_9 <= 5999999LL) goto block5;
...
block5:
        ...
        out_5++;
        if (out_5 <= 8666329LL) goto block9;
        else goto block15;
...
block15:
    ...
    // Interval: 500000000 - 944112594
    {
        ...
        int64_t addr_299600201 = 48001492LL, strd_299600201 = 0;
        int64_t addr_299700201 = 48001492LL, strd_299700201 = 0;
        int64_t addr_300800101 = 46665380LL, strd_300800101 = 0;
...
block20:
        ...
        switch(addr_300800101) {
            case 36000064LL : strd_300800101 = (36000068LL - 36000064LL); break;
            case 48000060LL : strd_300800101 = (36000064LL - 48000060LL); break;
            case 46665380LL : strd_300800101 = (46665384LL - 46665380LL); break;
        }
        addr_300800101 += strd_300800101;
        ...
        out_20++;
        if (out_20 <= 333670LL) goto block24;
        else if (out_20 <= 333671LL) goto block30;
        else if (out_20 <= 3333670LL) goto block24;
        else if (out_20 <= 3333671LL) goto block30;
        else if (out_20 <= 6333670LL) goto block24;
        else if (out_20 <= 6333671LL) goto block30;
        else goto block24;
...
block24:
        ...
        out_24++;
        if (out_24 <= 6627326LL) goto block25;
        else goto block31;
