    ...
    for(uint64_t loop2 = 0; loop2 < 256ULL; loop2++){
		for(uint64_t loop1 = 0; loop1 < 256ULL; loop1++){
		    for(uint64_t loop0 = 0; loop0 < 256ULL; loop0++){
		        __asm__ __volatile__ ("movl (%1,%2), %0" : "=r"(tmpl) : "r"(gm), "r"(addr_577600101) : "memory");
                switch(addr_577600101) {
                    case 1312768 : strd_577600101 = 4; break;
                    case 1313788 : strd_577600101 = -1020; break;
                    case 1573884 : strd_577600101 = -261116; break;
                }
                addr_577600101 += strd_577600101;
		    }
		}
	}
